...
const ErrorPage = () => (
    <div className='body'>
        <div className={cx('main-error-page')}>
            <svg
            ...
            >
                ...
                <g fill="none" fillRule="evenodd">
                    ...
                    <g>
                        ...
                        <g className={cx('full-torradeira')}>
            ...
            <h1 className={cx('error-title')}>Woops! Something went wrong :(</h1>
            <Link to='/' className={cx('btn btn-primary error-subtitle text-white')}>
                Back to home
            </Link>
        </div>
    </div>
